...
public class FirebaseDatabaseHelper {
    ...
    private List<News> newsTab = new ArrayList<>();
    ...
    public interface DataStatus{
        ...
        void DataCommentIsInserted(List<NewsComment> commentsTab, List<String> keys);
        void DataIsUpdated();
        void DataIsDeleted();
    }
    ...
    public FirebaseDatabaseHelper() {
        ...
        mReference = mDatabase.getReference("news");
    }
...
//                    }
                ...
                dataStatus.DataCommentIsInserted(tab, keys);
            }
